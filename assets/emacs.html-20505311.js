import{_ as s,p as n,q as a,a1 as e}from"./framework-5866ffd3.js";const i={},l=e(`<h1 id="emacs" tabindex="-1"><a class="header-anchor" href="#emacs" aria-hidden="true">#</a> emacs</h1><p>功能强大的全屏文本编辑器</p><h2 id="补充说明" tabindex="-1"><a class="header-anchor" href="#补充说明" aria-hidden="true">#</a> 补充说明</h2><p><strong>emacs命令</strong> 是由GNU组织的创始人Richard Stallman开发的一个功能强大的全屏文本编辑器，它支持多种编程语言，具有很多优良的特性。有众多的系统管理员和软件开发者使用emacs。</p><h3 id="语法" tabindex="-1"><a class="header-anchor" href="#语法" aria-hidden="true">#</a> 语法</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>emacs<span class="token punctuation">(</span>选项<span class="token punctuation">)</span><span class="token punctuation">(</span>参数<span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="参数" tabindex="-1"><a class="header-anchor" href="#参数" aria-hidden="true">#</a> 参数</h3><p>文件：指定要编辑的文本文件。</p><h2 id="emacs命令操作大全" tabindex="-1"><a class="header-anchor" href="#emacs命令操作大全" aria-hidden="true">#</a> emacs命令操作大全</h2><p>基本命令</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>C-x C-c <span class="token builtin class-name">:</span> 退出Emacs
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>编辑</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>C-z <span class="token punctuation">(</span>redefined<span class="token punctuation">)</span>: Undo；原来C-z是挂起Emacs（然后用fg命令调出）；C-x u 是默认的命令； 移动一下光标，再C-z就可以redo
M-d <span class="token builtin class-name">:</span> 删除光标后的词语
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>移动光标</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>C-v <span class="token builtin class-name">:</span> 向前翻页
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Buffer 相关</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>C-x k <span class="token builtin class-name">:</span> 关闭当前buffer
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>拷贝与粘贴</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>M-space <span class="token punctuation">(</span>redefined<span class="token punctuation">)</span>: 设置mark<span class="token punctuation">;</span> C-@ 是默认命令
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>窗口操作
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>搜索和替换</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>C-s <span class="token builtin class-name">:</span> 向前搜索（增量式搜索）；连续C-s，跳到下一个搜索到的目标
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Tags</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>M-<span class="token operator">!</span> etags .c .h <span class="token builtin class-name">:</span> 创建TAGS文件
M-. <span class="token builtin class-name">:</span> 跳到tag所在位置
M-x list-tags <span class="token builtin class-name">:</span> 列出tags
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>书签</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>C-x r m <span class="token builtin class-name">:</span> 设置书签bookmark
C-x r b <span class="token builtin class-name">:</span> 跳到bookmark处
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>帮助</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>C-h ? <span class="token builtin class-name">:</span> 查看帮助信息
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>其它</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>C-M-<span class="token punctuation">\\</span> <span class="token builtin class-name">:</span> 对选中区域，按照某种格式<span class="token punctuation">(</span>比如C程序<span class="token punctuation">)</span>进行格式化
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,32),c=[l];function t(p,d){return n(),a("div",null,c)}const r=s(i,[["render",t],["__file","emacs.html.vue"]]);export{r as default};
